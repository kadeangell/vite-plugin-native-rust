...
# `examples/astro` and "Include files outside the Root Directory" enabled, so
# the command runs with cwd = examples/astro but the full monorepo is present.
# We resolve the repo root relative to this script.
#
