...
# by this Qwik example. The Vite plugin shells out to `napi build --release`,
# which needs cargo on PATH; env from installCommand does not persist into
